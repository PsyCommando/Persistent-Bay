...
#define AI_STANCE_IDLE      HOSTILE_STANCE_IDLE
#define AI_STANCE_ALERT     HOSTILE_STANCE_ALERT
#define AI_STANCE_ATTACK    HOSTILE_STANCE_ATTACK
#define AI_STANCE_ATTACKING HOSTILE_STANCE_ATTACKING
#define AI_STANCE_TIRED     HOSTILE_STANCE_TIRED
#define AI_STANCE_INSIDE    HOSTILE_STANCE_INSIDE
#define AI_STANCE_MATE      7
#define AI_STANCE_MATING    8
#define AI_STANCE_ESCAPE    9
#define AI_STANCE_FEED     10
#define AI_STANCE_FEEDING  11
#define AI_STANCE_SLEEPING 12
