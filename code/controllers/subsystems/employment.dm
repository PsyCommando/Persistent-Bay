...
SUBSYSTEM_DEF(employment)
	name = "Employment"
	wait = 30 MINUTES
	next_fire = 30 MINUTES	// To prevent firing upon start
	runlevels = RUNLEVEL_GAME

/datum/controller/subsystem/employment/stat_entry()
	..("Next pay update in [round((next_fire - world.time) / (1 MINUTE), 0.1)] minutes.")

/datum/controller/subsystem/employment/fire(resumed = 0)
...
// 	// 	var/datum/world_faction/employer = FindFaction(stack.connected_faction)
// 	// 	if(employer)
