...
/hook/global_init/proc/InitIncineratorWorth()
	worths[/obj/machinery/incinerator/crematorium] = 600
...
/obj/machinery/incinerator
	...
	// id_tag = null
	// frequency = null
	// radio_filter = RADIO_INCINERATOR
...
/obj/machinery/incinerator/crematorium
	...
	var/obj/structure/crematorium_tray/connected = null
...
/obj/machinery/incinerator/crematorium/proc/open_tray()
	...
	src.connected = new /obj/structure/crematorium_tray( src.loc )
...
/obj/machinery/incinerator/crematorium/receive_signal(var/datum/signal/signal)
	if(!signal || signal.encryption || signal.data["tag"] != id_tag)
		return
...
/obj/structure/crematorium_tray/attack_hand(mob/user as mob)
	if (src.connected)
...
/obj/structure/crematorium_tray/attackby(var/obj/item/O as obj, var/mob/user as mob)
...
/obj/structure/crematorium_tray/MouseDrop_T(atom/movable/O as mob|obj, mob/user as mob)
