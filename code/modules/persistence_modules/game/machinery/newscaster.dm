...
/obj/machinery/newscaster/proc/payArticle(var/mob/user)
	...
	if(transaction_amount > account.money)
		...
		account.transfer(loaded_article.parent.parent.parent.central_account, transaction_amount, "Access to [loaded_article.name] ([loaded_article.parent.parent.name])")
...
/obj/machinery/newscaster/proc/payIssue(var/mob/user)
	...
	if(transaction_amount > account.money)
		...
		account.transfer(loaded_issue.parent.parent.central_account, transaction_amount, "Printed Issue [loaded_issue.name] ([loaded_issue.parent.name])")
