...
/obj/machinery/recycler
	...
	public_methods = list(
		/decl/public_access/public_method/recycler_toggle,
	)
...
/obj/machinery/recycler/proc/toggle()
	if(use_power)
		update_use_power(POWER_USE_IDLE)
	else
...
/obj/machinery/recycler/turn_on()
	..()
	update_sound()

/obj/machinery/recycler/turn_off()
	..()
	update_sound()

/decl/public_access/public_method/recycler_toggle
	name = "toggle"
	desc = "Toggle a recycler on and off."
	call_proc = /obj/machinery/recycler/proc/toggle

/decl/public_access/public_method/recycler_turnon
	name = "turn on"
	desc = "Toggle a recycler on."
	call_proc = /obj/machinery/proc/turn_on

/decl/public_access/public_method/recycler_turnoff
	name = "turn off"
	desc = "Toggle a recycler off."
	call_proc = /obj/machinery/proc/turn_off


/decl/stock_part_preset/radio/receiver/recycler
	frequency = BUTTON_FREQ
	receive_and_call = list(
		"button_active" = /decl/public_access/public_method/recycler_toggle
		)
