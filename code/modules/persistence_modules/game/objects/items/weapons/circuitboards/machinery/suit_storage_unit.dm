...
/obj/item/weapon/stock_parts/circuitboard/suit_storage_unit
...
/obj/item/weapon/stock_parts/circuitboard/suit_cycler
...
/obj/item/weapon/stock_parts/circuitboard/suit_cycler/attackby(obj/item/I, mob/user, params)
	if(isScrewdriver(I))
		set_type(pick(names_paths), user)

/obj/item/weapon/stock_parts/circuitboard/suit_cycler/proc/set_type(typepath, mob/user)
		build_path = typepath
