...
// 			var/list/datum/stock_holdings/stockholders = PSDB.factions.GetStockHoldings_ByFactionUID(connected_faction.uid)
// 			var/datum/stock_holdings/current_user

// 			for(var/datum/stock_holdings/H in stockholders)
// 				if(H.owner == user.real_name)
// 					current_user = H
// 				formatted_stockholders[++formatted_stockholders.len] = list("name" = "[H.owner] holds [H.number_stocks] stocks.")
// 			data["stockholders"] = formatted_stockholders
// 			//data["subscribed"] = current_user.subscribed
// 			data["holdings"] = current_user? current_user.number_stocks : "N/A"
...
// 		// 		return 1
// 		// 	if(connected_faction.owner_name && connected_faction.owner_name != "")
...
// 						</font>
// 				"}
// 				var/location = get_turf(program.computer)
// 				var/datum/money_account/Acc = get_money_account_by_name(usr.real_name)
// 				if(!Acc)
// 					to_chat(usr, SPAN_WARNING("[usr] doesn't seem to have a bank account."))
// 					return FALSE
// 				MakeStockContract(
// 					location, 
// 					t, 
// 					"[connected_faction.name] stock contract", 
// 					"Stock contract for [amount] stocks at [cost]$$",
// 					usr.real_name,
// 					Acc.account_number,
// 					usr.real_name,
// 					cost,
// 					amount,
// 					connected_faction.uid
// 					)
// 				playsound(location, pick('sound/items/polaroid1.ogg', 'sound/items/polaroid2.ogg'), 75, 1, -3)
// 		if("retract")
