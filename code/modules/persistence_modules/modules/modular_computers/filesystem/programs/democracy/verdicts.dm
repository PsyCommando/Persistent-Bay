...
// 	if(!ui)
// 		ui = new(user, src, ui_key, "verdicts.tmpl", name, 600, 500, state = state)
...
// 			program.computer.print_paper(selected_trial.body,selected_trial.name)

// 		if("print_verdict")
// 			if(!selected_verdict) return
// 			program.computer.print_paper(selected_verdict.body,selected_verdict.name)
