...
// 		var/datum/money_account/A = get_account(I.associated_account_number)
// 		if(A)
// 			data["balance"] = A.get_balance()
...
// 				if(final_price > get_money_account_balance_by_name(usr.real_name))
