/obj/machinery/fabricator/eva_fabricator
	...
	circuit_type = /obj/item/weapon/stock_parts/circuitboard/fabricator/evafab // Circuit for the machine. These, as well as their designs, should be defined in fabricator_circuits.dm
