/obj/machinery/fabricator/engineering_fabricator
	...
	circuit_type = /obj/item/weapon/stock_parts/circuitboard/fabricator/engfab // Circuit for the machine. These, as well as their designs, should be defined in fabricator_circuits.dm
...
/datum/design/item/engifab/engitools/simple/tape_roll
	name = "Tape Roll"
	build_path = /obj/item/stack/tape_roll
...
/datum/design/item/engifab/engitools/adv/light_replacer
	name = "Light replacer"
	materials = list(MATERIAL_STEEL = 1 SHEETS, MATERIAL_COPPER = 0.5 SHEETS, MATERIAL_GLASS = 1 SHEETS)
