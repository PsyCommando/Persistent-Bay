/obj/machinery/fabricator/storage_fabricator
	...
	circuit = /obj/item/weapon/stock_parts/circuitboard/fabricator/storagefab // Circuit for the machine. These, as well as their designs, should be defined in fabricator_circuits.dm
