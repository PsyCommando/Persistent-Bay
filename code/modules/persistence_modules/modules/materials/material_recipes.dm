...
/material/get_recipes(var/reinf_mat)
...
/material/create_recipe_list(base_type)
	. = list()
	for(var/recipe_type in subtypesof(base_type))
		. += new recipe_type(src)

/material/generate_recipes(var/reinforce_material)
	. = list()
	...
	recipes_buffer.items += new/datum/stack_recipe/cross(src)

	if(hardness >= MATERIAL_FLEXIBLE)
		recipes_buffer.items += new/datum/stack_recipe/baseball_bat(src)
		recipes_buffer.items += new/datum/stack_recipe/urn(src)
	...
	if(integrity >= 50 && hardness >= MATERIAL_FLEXIBLE + 10)
		...
		recipes_buffer.furnitures += new/datum/stack_recipe/furniture/barricade(src)
		...
		recipes_buffer.furnitures += new/datum/stack_recipe/furniture/pew(src)
		recipes_buffer.furnitures += new/datum/stack_recipe/furniture/pew_left(src)
		...
		recipes_buffer.structures += new/datum/stack_recipe_list("padded [display_name] chairs", create_recipe_list(/datum/stack_recipe/furniture/chair/padded))
		...
		recipes_buffer.structures += new/datum/stack_recipe/furniture/table_frame(src)
	...
	if(hardness > MATERIAL_RIGID + 10)
		...
		recipes_buffer.items += new/datum/stack_recipe/drill_head(src)
...
/material/steel/generate_recipes(var/reinforce_material)
	...
	recipes_buffer.furnitures += new/datum/stack_recipe/furniture/coffin(src)
