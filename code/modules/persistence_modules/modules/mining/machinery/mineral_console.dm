/obj/machinery/computer/mining
	...
	base_type = /obj/machinery/computer/mining
	var/list/obj/machinery/mining/connected = list()
...
/obj/machinery/computer/mining/New()
	..()
	ADD_SAVED_VAR(map_storage_saved_vars)
	ADD_SAVED_VAR(connected_coordinates)
