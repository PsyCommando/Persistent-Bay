// /obj/item/weapon/stock_parts/circuitboard/telecomms/bluespace_satellite
...
// /obj/machinery/bluespace_satellite/OnTopic(mob/user, href_list, datum/topic_state/state)
...
// 		new_faction.owner_name = starting_leader
// 		new_faction.network.invisible = 1
// 		new_faction.network.uid = chosen_netuid
