/mob/living/simple_animal/spiderbot
	...
	var/obj/item/device/mmi/lmi/mmi = null
...
/mob/living/simple_animal/spiderbot/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(istype(O, /obj/item/device/mmi/lmi))
		var/obj/item/device/mmi/lmi/B = O
		if(src.mmi)
	...
	if(isWelder(O))
		...
		if(core_access_science_programs in id_card.access)
...
/mob/living/simple_animal/spiderbot/proc/transfer_personality(var/obj/item/device/mmi/lmi/M as obj)
