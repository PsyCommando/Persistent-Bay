//Docking beacons are deprecated
...
// 			shuttle_owner = id.selected_faction_uid
// 	return ..()
...
// 			return
// 		if(ownership_type)
// 			var/datum/computer_file/report/crew_record/record = GetGlobalCrewRecord(shuttle_owner)
// 			if(!record)
// 				shuttle_owner = null
// 				return 1
...
// 				return 1
// 		else
// 			var/datum/world_faction/faction = FindFaction(shuttle_owner)
// 			if(!faction)
// 				shuttle_owner = null
// 				return 1
...
// 				highlight()
// 	if(href_list["sync"])
// 		faction = FindFaction(usr.get_faction())
// 		if(faction)
...
// 		if(select_name)
// 			var/datum/computer_file/report/crew_record/record = GetGlobalCrewRecord(select_name)
// 			if(!record)
...
// 		faction = FindFaction(req_access_faction)
