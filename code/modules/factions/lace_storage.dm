...
/proc/GetLaceStorage(var/mob/living/carbon/brain/lace/character)
	// var/returnLoc = null
	// for(var/obj/machinery/lace_storage/S in GLOB.lace_storages)
	// 	if(S.req_access_faction == character.saved_cryonet.cryonet_faction_uid || S.req_access_faction == character.container.connected_faction)
	// 		if(S.network == character.saved_cryonet.cryonet_name)
	// 			returnLoc = S
	// 			break
	// 		else
	// 			returnLoc = S
...
// 			if(id)
// 				var/datum/world_faction/faction = FindFaction(id.selected_faction_uid)
// 				if(faction)
// 					req_access_faction = id.selected_faction_uid
...
// 		if ("despawn")
// 			var/mob/living/carbon/brain/lace/mob = usr
...
// 	if (istype(user, /mob/living/carbon/brain/lace))
// 		data["living"] = FALSE
// 	else
// 		var/datum/world_faction/faction = FindFaction(req_access_faction)
...
// 		var/mob/living/carbon/brain/lace/mob = S.lacemob
